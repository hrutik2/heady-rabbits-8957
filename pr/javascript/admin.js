...
function fetchdata(){
  ...
  function fetchdata2(fromCurrency){
    fetch(`https://64889f370e2469c038fe1ba1.mockapi.io/users/${fromCurrency}`)
...
function d(id){
   // console.log(id)
    fetch(`${"https://64889f370e2469c038fe1ba1.mockapi.io/currency"}/${id}`, {
        method: 'DELETE',
